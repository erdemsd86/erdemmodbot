...
const embed = new MessageEmbed().setAuthor(message.author.tag, message.author.avatarURL({dynamic:true})).setColor(client.generalColor()).setFooter(`Developed By Striga.`)
const nembed = new MessageEmbed().setAuthor(message.author.tag, message.author.avatarURL({dynamic:true})).setColor(client.warnColor()).setFooter(`Developed By Striga.`) 
